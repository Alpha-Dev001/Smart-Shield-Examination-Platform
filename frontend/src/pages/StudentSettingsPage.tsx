        ...
        <div className="grid gap-6 sm:grid-cols-2">
          <div className="space-y-4">
            <div className="smesh-card-soft p-4">
              <div className="text-xs font-medium text-[#5b6474] mb-1">Student ID</div>
              <div className="text-sm font-mono text-[#0b1220]">{auth.user?.id}</div>
            </div>

            <div className="smesh-card-soft p-4">
              <div className="text-xs font-medium text-[#5b6474] mb-1">Email Address</div>
              <div className="text-sm text-[#0b1220]">{auth.user?.email}</div>
            </div>

            <div className="smesh-card-soft p-4">
              <div className="text-xs font-medium text-[#5b6474] mb-1">Account Role</div>
              <div className="text-sm text-[#0b1220] capitalize">{auth.user?.role?.toLowerCase()}</div>
            </div>
          </div>

          <div className="space-y-4">
            <div className="smesh-card-soft p-4">
              <div className="text-xs font-medium text-[#5b6474] mb-1">Class ID</div>
              <div className="text-sm text-[#0b1220]">{auth.user?.classId || 'Not assigned'}</div>
            </div>
